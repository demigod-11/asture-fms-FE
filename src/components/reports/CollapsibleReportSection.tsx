  ...
  return (
    <div className='border-b border-gray-100 dark:border-gray-700 last:border-b-0'>
      <button
        ...
        className='w-full flex items-center justify-between py-2.5 text-left hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors'
      ...
      >
        <span className='flex items-center gap-1.5'>
          ...
          <span
            className={`font-medium text-gray-900 dark:text-gray-100 ${level === 0 ? 'text-sm' : 'text-sm'}`}
          >
            {title}
          </span>
        </span>
